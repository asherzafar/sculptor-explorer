    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-text-secondary leading-relaxed mb-3">
          The published dataset includes <strong className="text-text-primary">3,600+ sculptors</strong>{" "}
        ...
        <p className="text-text-secondary leading-relaxed mb-3">
          The <strong className="text-text-primary">lineage graph</strong> also includes 680+ non-sculptor
        ...
        <p className="text-text-secondary leading-relaxed mb-3">
          A smaller <strong className="text-text-primary">curated focus list</strong> (~48 sculptors), assembled
      ...
      <section className="mb-8">
        <h2 className="font-display text-xl font-semibold text-text-primary mb-3">Data Sources</h2>
        <p className="text-text-secondary leading-relaxed mb-3">
          <strong className="text-text-primary">Current:</strong>
        </p>
        <ul className="space-y-2 text-text-secondary mb-4">
          <li>
            <strong className="text-text-primary">Wikidata (QLever + WDQS)</strong> —
        ...
        <p className="text-text-secondary leading-relaxed mb-3">
          <strong className="text-text-primary">Planned:</strong>
        </p>
        <ul className="space-y-2 text-text-secondary">
          <li>
            <strong className="text-text-primary">Met Museum API</strong> —
            Object-level data (materials, dates)
          </li>
          <li>
            <strong className="text-text-primary">Art Institute of Chicago API</strong> —
            Additional museum data
          </li>
          <li>
            <strong className="text-text-primary">Getty ULAN</strong> —
