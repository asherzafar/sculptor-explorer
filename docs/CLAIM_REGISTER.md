...
| Explore | Searchable published roster and source fields | Wikidata plus explicit overrides | 3,543 published of 6,710 analytically eligible candidates after one evidence-backed exclusion from 6,711 source candidates | Missing values render as em dash; movement coverage is 962/3,543; sparse movement labels remain text rather than dead aggregate links; labels are source assertions |
