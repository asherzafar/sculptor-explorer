...
REFRESH_FROM_INSTITUTIONS = False
REFRESH_FROM_GETTY = False
...
ENDPOINT_LABELS_CACHE_PATH = raw_cache_path("relation_endpoint_labels")
MENTOR_META_CACHE_PATH = raw_cache_path("mentor_meta")
